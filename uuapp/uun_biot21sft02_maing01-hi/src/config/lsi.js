const Lsi = {
  appName: {
    cs: "Aplikace uunBiot21sft02",
    en: "Application uunBiot21sft02",
  },
  ...
  about: {
    header: {
      cs: "O aplikaci uunBiot21sft02",
      en: "About application uunBiot21sft02",
    },
    creatorsHeader: {
      cs: "Tvůrci aplikace",
  ...
  unauthInit: {
    buyYourOwn: {
      cs: "Můžete si koupit vlastní uunBiot21sft02.",
      en: "You can buy your own uunBiot21sft02.",
    },
    notAuthorized: {
      cs: "Nemáte právo inicializovat tuto aplikaci uunBiot21sft02.",
      en: "You don't have rights to initialize this uunBiot21sft02.",
    },
  },
